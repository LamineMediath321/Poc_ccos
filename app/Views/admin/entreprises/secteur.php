                                ...
                                <tr>
                                    ...
                                    <td class=" py-0 ">
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-primary btn-success" href="#" data-toggle="modal" data-target="#modal_form_show" onclick="show(<?php echo $secteur['idSecteur']; ?>)"><i class="fa fa-eye"></i></button>
