                         ...
                         <div class="row">
                             ...
                             <div class="col-12 col-md-6">
                                 <div class="form-group" id="select_contain_show">
                                     <label for="secteur">Selectionner le secteur d'Activité de l'Entreprise</label>
                                     <select name="secteur" class="select2 form-control custom-select " data-style="btn-success" data-container="select_contain" required>
